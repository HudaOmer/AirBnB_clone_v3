#!/usr/bin/python3
"""
module for flask route that returns json status response
"""
...
def states_no_id():
    """
    the states route to handle http method for requested states no id provided
    """
...
def states_with_id(state_id=None):
    """
    the states route to handle http method for requested state by id
    """
